...
func (_q *OAuthTokenQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *OAuthTokenQuery) FirstIDX(ctx context.Context) string {
...
func (_q *OAuthTokenQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *OAuthTokenQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *OAuthTokenQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *OAuthTokenQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
